...
namespace FitnessProject.Controllers
{
    public class BlogsController : Controller
    {
        ...
        public ActionResult Detail(int id)
        {
            ...
            if (post == null)
            {
                // Nếu không tìm thấy, có thể chuyển hướng hoặc xử lý theo nhu cầu của bạn
                return RedirectToAction("Index"); // Hoặc chuyển hướng đến trang lỗi khác
            }

            // Nếu tìm thấy bài viết, truyền dữ liệu đó vào model và trả về view chi tiết
            return View(post);
        }
